...
namespace ravendb::client::documents::indexes
{
	...
	protected:
		...
		std::unordered_map<std::string, spatial::SpatialOptions> spatial_options_strings{};
	...
	protected:
		...
		void spatial(std::string field, std::function<spatial::SpatialOptions(const spatial::SpatialOptionsFactory&)> indexing);
