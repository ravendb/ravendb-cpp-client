...
namespace ravendb::client::documents::queries::spatial
{
	...
	{
		return relates_to_shape(std::move(shape_wkt), relation, constants::documents::indexing::spatial::DEFAULT_DISTANCE_ERROR_PCT);
	}
	...
	{
		return intersect(std::move(shape_wkt), constants::documents::indexing::spatial::DEFAULT_DISTANCE_ERROR_PCT);
	}
	...
	{
		return contains(std::move(shape_wkt), constants::documents::indexing::spatial::DEFAULT_DISTANCE_ERROR_PCT);
	}
	...
	{
		return disjoint(std::move(shape_wkt), constants::documents::indexing::spatial::DEFAULT_DISTANCE_ERROR_PCT);
	}
	...
	{
		return within(std::move(shape_wkt), constants::documents::indexing::spatial::DEFAULT_DISTANCE_ERROR_PCT);
	}
