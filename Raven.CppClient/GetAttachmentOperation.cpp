...
{
	GetAttachmentOperation::GetAttachmentOperation(std::string document_id, std::string name,
	...
	std::unique_ptr<http::RavenCommand<AttachmentResult>> GetAttachmentOperation::get_command(
	...
	GetAttachmentOperation::GetAttachmentCommand::GetAttachmentCommand(std::string document_id, std::string name,
		documents::attachments::AttachmentType type, std::optional<std::string> change_vector)
		: _document_id([&]()
	{
	...
	void GetAttachmentOperation::GetAttachmentCommand::create_request(impl::CurlHandlesHolder::CurlReference& curl_ref,
	...
	http::ResponseDisposeHandling GetAttachmentOperation::GetAttachmentCommand::process_response(
		std::shared_ptr<http::HttpCache> cache, const impl::CurlResponse& response, const std::string& url)
	{
	...
	bool GetAttachmentOperation::GetAttachmentCommand::is_read_request() const
	{
		return true;
	}
}
